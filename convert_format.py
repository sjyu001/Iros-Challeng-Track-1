...
def parse_args():
    ...
    parser.add_argument('--dataroot', type=str, default='/raid/workspace/sjyu/iros_challenge/data/nuscenes/trainval', help='NuScenes data root')
...
# python convert_format.py /raid/workspace/sjyu/iros_challenge/data/robosense_track1_release.json /raid/workspace/sjyu/iros_challenge/data/robosense_track1_realese_convert_temporal_7.json --use-temporal --num-frames 7